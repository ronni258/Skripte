...
%     Data   = load(fullfile('F:\Messdaten\040_Volkswagen_Passat_WOB_OQ_616\Landstraße', FileList(iFile).name));
...
Ergebnis01_kM(10,1)=fzg_x_t00(1,(Ergebnis01_kM(4,1)*int));
for c=2:size(Ergebnis01_kM,2)
Ergebnis01_kM(10,c)=(fzg_x_t00(1,Ergebnis01(4,c)*int)-fzg_x_t00(1,Ergebnis01(4,c-1)*int));
end


%Maximale Querberschleunigung
Ergebnis01_kM(6,1)=min(fzg_ypp_t00_average(1,1:(Ergebnis01_kM(4,1)*int)));
Ergebnis01_kM(7,1)=max(fzg_ypp_t00_average(1,1:(Ergebnis01_kM(4,1)*int)));
Ergebnis01_kM(8,1)=mean(fzg_ypp_t00_average(1,1:(Ergebnis01_kM(4,1)*int)));
for c=2:size(Ergebnis01_kM,2)
Ergebnis01_kM(6,c)=min(fzg_ypp_t00_average(1,(Ergebnis01_kM(4,c-1)*int):(Ergebnis01_kM(4,c)*int)));
Ergebnis01_kM(7,c)=max(fzg_ypp_t00_average(1,(Ergebnis01_kM(4,c-1)*int):(Ergebnis01_kM(4,c)*int)));
Ergebnis01_kM(8,c)=mean(fzg_ypp_t00_average(1,(Ergebnis01_kM(4,c-1)*int):(Ergebnis01_kM(4,c)*int)));
end
...
Ergebnis01_kM(12,1)=min(fzg_xp_t00(1,1:(Ergebnis01_kM(4,1)*int)));
Ergebnis01_kM(13,1)=max(fzg_xp_t00(1,1:(Ergebnis01_kM(4,1)*int)));
Ergebnis01_kM(14,1)=mean(fzg_xp_t00(1,1:(Ergebnis01_kM(4,1)*int)));
for c=2:size(Ergebnis01_kM,2)
Ergebnis01_kM(12,c)=min(fzg_xp_t00(1,(Ergebnis01_kM(4,c-1)*int):(Ergebnis01_kM(4,c)*int)));
Ergebnis01_kM(13,c)=max(fzg_xp_t00(1,(Ergebnis01_kM(4,c-1)*int):(Ergebnis01_kM(4,c)*int)));
Ergebnis01_kM(14,c)=mean(fzg_xp_t00(1,(Ergebnis01_kM(4,c-1)*int):(Ergebnis01_kM(4,c)*int)));
end
...
if  Ergebnis01_kM(32,1)>0
    Ergebnis01_kM(18,1)=1/(max(fas_kamera_bv1_LIN_1_2_HorKruemm_t00_average(1,1:(Ergebnis01_kM(4,1)*int))));
else
    Ergebnis01_kM(18,1)=1/(min(fas_kamera_bv1_LIN_1_2_HorKruemm_t00_average(1,1:(Ergebnis01_kM(4,1)*int))));
end
    Ergebnis01_kM(19,1)=1/(mean(fas_kamera_bv1_LIN_1_2_HorKruemm_t00_average(1,1:(Ergebnis01_kM(4,1)*int))));
for c=2:size(Ergebnis01_kM,2)
if Ergebnis01_kM(32,c)>0
    Ergebnis01_kM(18,c)=1/(max(fas_kamera_bv1_LIN_1_2_HorKruemm_t00_average(1,(Ergebnis01_kM(4,c-1)*int):(Ergebnis01_kM(4,c)*int))));    
else
    Ergebnis01_kM(18,c)=1/(min(fas_kamera_bv1_LIN_1_2_HorKruemm_t00_average(1,(Ergebnis01_kM(4,c-1)*int):(Ergebnis01_kM(4,c)*int))));    

end
Ergebnis01_kM(19,c)=1/(mean(fas_kamera_bv1_LIN_1_2_HorKruemm_t00_average(1,(Ergebnis01_kM(4,c-1)*int):(Ergebnis01_kM(4,c)*int))));
end
...
if  Ergebnis01_kM(19,1)>0 % Wenn > 0 --> Linkskurve
    Ergebnis01_kM(22,1)=max((abs(fas_kamera_bv1_LIN_02_AbstandY_t00(1,1:Ergebnis01_kM(4,1)*int))-fas_kamera_bv1_LIN_01_AbstandY_t00(1,1:Ergebnis01_kM(4,1)*int))/2);
else
    Ergebnis01_kM(22,1)=min((abs(fas_kamera_bv1_LIN_02_AbstandY_t00(1,1:Ergebnis01_kM(4,1)*int))-fas_kamera_bv1_LIN_01_AbstandY_t00(1,1:Ergebnis01_kM(4,1)*int))/2);
end
Ergebnis01_kM(24,1)=(abs(fas_kamera_bv1_LIN_02_AbstandY_t00(1,1))-fas_kamera_bv1_LIN_01_AbstandY_t00(1,1))/2;
...
if  Ergebnis01_kM(19,c)>0
    Ergebnis01_kM(22,c)=max((abs(fas_kamera_bv1_LIN_02_AbstandY_t00(1,Ergebnis01_kM(4,c-1)*int:Ergebnis01_kM(4,c)*int))-fas_kamera_bv1_LIN_01_AbstandY_t00(1,Ergebnis01_kM(4,c-1)*int:Ergebnis01_kM(4,c)*int))/2);
else
    Ergebnis01_kM(22,c)=min((abs(fas_kamera_bv1_LIN_02_AbstandY_t00(1,Ergebnis01_kM(4,c-1)*int:Ergebnis01_kM(4,c)*int))-fas_kamera_bv1_LIN_01_AbstandY_t00(1,Ergebnis01_kM(4,c-1)*int:Ergebnis01_kM(4,c)*int))/2);  
end

    Ergebnis01_kM(24,c)=(abs(fas_kamera_bv1_LIN_02_AbstandY_t00(1,(Ergebnis01_kM(4,c-1)+1)*int))-fas_kamera_bv1_LIN_01_AbstandY_t00(1,(Ergebnis01_kM(4,c-1)+1)*int))/2;
...
Ergebnis01_kM(30,c)=fas_kamera_bv1_LIN_1_2_HorKruemm_t00_average(1,Ergebnis01_kM(28,c));
