...
% normierte maximale Querablage über Kruemmung
fig_11=figure ('Name','Qab_max_norm/Kruemmung_0400_0450');
title ('normierter maximale Querablage ueber Kruemmung')
...
%% Vorbereitung fuer Verlauf verschiedener Parameter ueber die Kurvenlaenge
...
title ('Verlauf Querbeschleunigung ueber Kurvenlaenge')
subtitle('Rechtskurve - Kurvenradius 400-450m')
grid on
hold on 
xlabel ('Kurvenlaenge')
...
fig_7=figure ('Name','Kruemmung_0400_0450/Kurvenlaenge_0400_0450');
title ('Verlauf Kruemmung ueber Kurvenlaenge')
subtitle('Rechtskurve - Kurvenradius 400-450m')
grid on
hold on 
xlabel ('Kurvenlaenge')
...
title ('Verlauf normierter Querablage ueber Kurvenlaenge')
subtitle('Rechtskurve - Kurvenradius 400-450m')
grid on
hold on 
xlabel ('Kurvenlaenge')
...
title ('Verlauf Geschwindigkeit ueber Kurvenlaenge')
subtitle('Rechtskurve - Kurvenradius 400-450m')
grid on
hold on 
xlabel ('Kurvenlaenge')
...
%Verlauf normierte Querablage über Kruemmung
fig_10=figure ('Name','Qab_0400_0450/Kruemmung_0400_0450');
title ('Verlauf normierter Querablage ueber Kruemmung')
subtitle('Rechtskurve - Kurvenradius 400-450m')
grid on
hold on 
xlabel ('Kruemmung')
