...
anzahl=fix(size(fas_kamera_bv1_LIN_01_AbstandY_t00,2)/(int*10))*(int*10);
...
[xEast,yNorth,zUp] = latlon2local(gps_Breitengrad_t00,gps_Laengengrad_t00,gps_Hoehe_t00,origin);
...
%%% Anzahl der Messpunkte innerhalb einer Kurve und nicht auf der
%%% zurueckgelgeten Distanz

%Spurbreite der Fahrspur
Sb=fas_kamera_bv1_LIN_01_AbstandY_t00+abs(fas_kamera_bv1_LIN_02_AbstandY_t00);
...
% 03.   Abschnittslaenge
    ...
    Ergebnis_Kr(3,n)=(fzg_x_t00(1,Ergebnis_Kr(10,n))-fzg_x_t00(1,Ergebnis_Kr(5,n)));
...
% 21.   durchschnittliche Querablage
        ...
        Ergebnis_Kr(14,n)=(abs(fas_kamera_bv1_LIN_02_AbstandY_t00(1,(Ergebnis_Kr(5,n))))-fas_kamera_bv1_LIN_01_AbstandY_t00(1,(Ergebnis_Kr(5,n))))/2;
        Ergebnis_Kr(15,n)=(abs(fas_kamera_bv1_LIN_02_AbstandY_t00(1,(Ergebnis_Kr(6,n))))-fas_kamera_bv1_LIN_01_AbstandY_t00(1,(Ergebnis_Kr(6,n))))/2;
        Ergebnis_Kr(16,n)=(abs(fas_kamera_bv1_LIN_02_AbstandY_t00(1,(Ergebnis_Kr(7,n))))-fas_kamera_bv1_LIN_01_AbstandY_t00(1,(Ergebnis_Kr(7,n))))/2;
        Ergebnis_Kr(17,n)=(abs(fas_kamera_bv1_LIN_02_AbstandY_t00(1,(Ergebnis_Kr(8,n))))-fas_kamera_bv1_LIN_01_AbstandY_t00(1,(Ergebnis_Kr(8,n))))/2;
        Ergebnis_Kr(18,n)=(abs(fas_kamera_bv1_LIN_02_AbstandY_t00(1,(Ergebnis_Kr(9,n))))-fas_kamera_bv1_LIN_01_AbstandY_t00(1,(Ergebnis_Kr(9,n))))/2;
        Ergebnis_Kr(19,n)=(abs(fas_kamera_bv1_LIN_02_AbstandY_t00(1,(Ergebnis_Kr(10,n))))-fas_kamera_bv1_LIN_01_AbstandY_t00(1,(Ergebnis_Kr(10,n))))/2;
    if  Ergebnis_Kr(2,n)>0
        Ergebnis_Kr(20,n)=max((abs(fas_kamera_bv1_LIN_02_AbstandY_t00(1,Ergebnis_Kr(5,n):Ergebnis_Kr(10,n)))-fas_kamera_bv1_LIN_01_AbstandY_t00(1,Ergebnis_Kr(5,n):Ergebnis_Kr(10,n)))/2);
    else
        Ergebnis_Kr(20,n)=min((abs(fas_kamera_bv1_LIN_02_AbstandY_t00(1,Ergebnis_Kr(5,n):Ergebnis_Kr(10,n)))-fas_kamera_bv1_LIN_01_AbstandY_t00(1,Ergebnis_Kr(5,n):Ergebnis_Kr(10,n)))/2);  
    end
        Ergebnis_Kr(21,n)=mean((abs(fas_kamera_bv1_LIN_02_AbstandY_t00(1,Ergebnis_Kr(5,n):Ergebnis_Kr(10,n)))-fas_kamera_bv1_LIN_01_AbstandY_t00(1,Ergebnis_Kr(5,n):Ergebnis_Kr(10,n)))/2);  
...
% 11.   Messpunkt bei der maximalen Querablage
    ...
    if isnan(Ergebnis_Kr(20,n))
        ...
        Ergebnis_Kr(11,n)=(find(((abs(fas_kamera_bv1_LIN_02_AbstandY_t00(1,Ergebnis_Kr(5,n):Ergebnis_Kr(10,n)))-fas_kamera_bv1_LIN_01_AbstandY_t00(Ergebnis_Kr(5,n):Ergebnis_Kr(10,n)))/2)==Ergebnis_Kr(20,n),1,'first')-1+Ergebnis_Kr(5,n));
    end
...
% 76.   durchschnittliche Geschwindigkeit
        ...
        Ergebnis_Kr(67,n)=(fzg_xp_t00(1,Ergebnis_Kr(5,n)));
        Ergebnis_Kr(68,n)=(fzg_xp_t00(1,Ergebnis_Kr(6,n)));
        Ergebnis_Kr(69,n)=(fzg_xp_t00(1,Ergebnis_Kr(7,n)));
        Ergebnis_Kr(70,n)=(fzg_xp_t00(1,Ergebnis_Kr(8,n)));
        Ergebnis_Kr(71,n)=(fzg_xp_t00(1,Ergebnis_Kr(9,n)));
        Ergebnis_Kr(72,n)=(fzg_xp_t00(1,Ergebnis_Kr(10,n)));
    if isnan(Ergebnis_Kr(11,n))
        Ergebnis_Kr(73,n)=NaN;
    else
        Ergebnis_Kr(73,n)=(fzg_xp_t00(1,Ergebnis_Kr(11,n)));
    end
        Ergebnis_Kr(74,n)=max(fzg_xp_t00(1,(Ergebnis_Kr(5,n)):(Ergebnis_Kr(10,n))));
        Ergebnis_Kr(75,n)=min(fzg_xp_t00(1,(Ergebnis_Kr(5,n)):(Ergebnis_Kr(10,n))));
        Ergebnis_Kr(76,n)=mean(fzg_xp_t00(1,(Ergebnis_Kr(5,n)):(Ergebnis_Kr(10,n))));



% 79.   realtive Kurvendistanz bei Kurvenbeginn (immer 0)
% 80.   realtive Kurvendistanz bei 0.2 der Kurve (20% der Kurvenlaenge) 
% 81.   realtive Kurvendistanz bei 0.4 der Kurve (40% der Kurvenlaenge)
% 82.   realtive Kurvendistanz bei 0.6 der Kurve (60% der Kurvenlaenge)
% 83.   realtive Kurvendistanz bei 0.8 der Kurve (80% der Kurvenlaenge)
% 84.   realtive Kurvendistanz bei Kurvenende (entspricht Kurvenlaenge)
% 85.   realtive Kurvendistanz bei maximaler Querablage
        
        Kl=fzg_x_t00(Ergebnis_Kr(10,n))-fzg_x_t00(Ergebnis_Kr(5,n)); %Kl= Kurvenlaenge
        Ergebnis_Kr(79,n)=0;
    ...
    if isnan(Ergebnis_Kr(11,n))
        ...
        Ergebnis_Kr(85,n)=fzg_x_t00(Ergebnis_Kr(11,n))-fzg_x_t00(Ergebnis_Kr(5,n));
    end
...
% 94.   Messpunkt der realtiven Kurvendistanz bei maximaler Querablage
        ...
        Ergebnis_Kr(89,n)=find(fzg_x_t00>fzg_x_t00(Ergebnis_Kr(5,n))+(Kl*0.2),1,'first');
        Ergebnis_Kr(90,n)=find(fzg_x_t00>fzg_x_t00(Ergebnis_Kr(5,n))+(Kl*0.4),1,'first');
        Ergebnis_Kr(91,n)=find(fzg_x_t00>fzg_x_t00(Ergebnis_Kr(5,n))+(Kl*0.6),1,'first');
        Ergebnis_Kr(92,n)=find(fzg_x_t00>fzg_x_t00(Ergebnis_Kr(5,n))+(Kl*0.8),1,'first');
        Ergebnis_Kr(93,n)=Ergebnis_Kr(10,n);
    if isnan(Ergebnis_Kr(11,n))
        Ergebnis_Kr(94,n)=NaN;
    else        
        Ergebnis_Kr(94,n)=find(fzg_x_t00>fzg_x_t00(Ergebnis_Kr(5,n))+(fzg_x_t00(Ergebnis_Kr(11,n))-fzg_x_t00(Ergebnis_Kr(5,n))),1,'first');
    end
...
% 104.   durchschnittliche Querablage
        ...
        Ergebnis_Kr(97,n)=(abs(fas_kamera_bv1_LIN_02_AbstandY_t00(1,(Ergebnis_Kr(88,n))))-fas_kamera_bv1_LIN_01_AbstandY_t00(1,(Ergebnis_Kr(88,n))))/2;
        Ergebnis_Kr(98,n)=(abs(fas_kamera_bv1_LIN_02_AbstandY_t00(1,(Ergebnis_Kr(89,n))))-fas_kamera_bv1_LIN_01_AbstandY_t00(1,(Ergebnis_Kr(89,n))))/2;
        Ergebnis_Kr(99,n)=(abs(fas_kamera_bv1_LIN_02_AbstandY_t00(1,(Ergebnis_Kr(90,n))))-fas_kamera_bv1_LIN_01_AbstandY_t00(1,(Ergebnis_Kr(90,n))))/2;
        Ergebnis_Kr(100,n)=(abs(fas_kamera_bv1_LIN_02_AbstandY_t00(1,(Ergebnis_Kr(91,n))))-fas_kamera_bv1_LIN_01_AbstandY_t00(1,(Ergebnis_Kr(91,n))))/2;
        Ergebnis_Kr(101,n)=(abs(fas_kamera_bv1_LIN_02_AbstandY_t00(1,(Ergebnis_Kr(92,n))))-fas_kamera_bv1_LIN_01_AbstandY_t00(1,(Ergebnis_Kr(92,n))))/2;
        Ergebnis_Kr(102,n)=(abs(fas_kamera_bv1_LIN_02_AbstandY_t00(1,(Ergebnis_Kr(93,n))))-fas_kamera_bv1_LIN_01_AbstandY_t00(1,(Ergebnis_Kr(93,n))))/2;
    if  Ergebnis_Kr(2,n)>0
        Ergebnis_Kr(103,n)=max((abs(fas_kamera_bv1_LIN_02_AbstandY_t00(1,Ergebnis_Kr(88,n):Ergebnis_Kr(93,n)))-fas_kamera_bv1_LIN_01_AbstandY_t00(1,Ergebnis_Kr(88,n):Ergebnis_Kr(93,n)))/2);
    else
        Ergebnis_Kr(103,n)=min((abs(fas_kamera_bv1_LIN_02_AbstandY_t00(1,Ergebnis_Kr(88,n):Ergebnis_Kr(93,n)))-fas_kamera_bv1_LIN_01_AbstandY_t00(1,Ergebnis_Kr(88,n):Ergebnis_Kr(93,n)))/2);  
    end
        Ergebnis_Kr(104,n)=mean((abs(fas_kamera_bv1_LIN_02_AbstandY_t00(1,Ergebnis_Kr(88,n):Ergebnis_Kr(93,n)))-fas_kamera_bv1_LIN_01_AbstandY_t00(1,Ergebnis_Kr(88,n):Ergebnis_Kr(93,n)))/2);  
...
% 94.   Messpunkt bei der maximalen Querablage
    ...
    if isnan(Ergebnis_Kr(103,n))
        ...
        Ergebnis_Kr(94,n)=(find(((abs(fas_kamera_bv1_LIN_02_AbstandY_t00(1,Ergebnis_Kr(88,n):Ergebnis_Kr(93,n)))-fas_kamera_bv1_LIN_01_AbstandY_t00(Ergebnis_Kr(88,n):Ergebnis_Kr(93,n)))/2)==Ergebnis_Kr(103,n),1,'first')-1+Ergebnis_Kr(88,n));
    end
...
% 159.   durchschnittliche Geschwindigkeit
        ...
        Ergebnis_Kr(150,n)=(fzg_xp_t00(1,Ergebnis_Kr(88,n)));
        Ergebnis_Kr(151,n)=(fzg_xp_t00(1,Ergebnis_Kr(89,n)));
        Ergebnis_Kr(152,n)=(fzg_xp_t00(1,Ergebnis_Kr(90,n)));
        Ergebnis_Kr(153,n)=(fzg_xp_t00(1,Ergebnis_Kr(91,n)));
        Ergebnis_Kr(154,n)=(fzg_xp_t00(1,Ergebnis_Kr(92,n)));
        Ergebnis_Kr(155,n)=(fzg_xp_t00(1,Ergebnis_Kr(93,n)));
    if isnan(Ergebnis_Kr(94,n))
        Ergebnis_Kr(156,n)=NaN;
    else
        Ergebnis_Kr(156,n)=(fzg_xp_t00(1,Ergebnis_Kr(94,n)));
    end
        Ergebnis_Kr(157,n)=max(fzg_xp_t00(1,(Ergebnis_Kr(88,n)):(Ergebnis_Kr(93,n))));
        Ergebnis_Kr(158,n)=min(fzg_xp_t00(1,(Ergebnis_Kr(88,n)):(Ergebnis_Kr(93,n))));
        Ergebnis_Kr(159,n)=mean(fzg_xp_t00(1,(Ergebnis_Kr(88,n)):(Ergebnis_Kr(93,n)))); 
...
% 167.   realtive Kurvendistanz bei Kurvenende
        ...
        Ergebnis_Kr(162,n)=fzg_x_t00(Ergebnis_Kr(5,n))-fzg_x_t00(Ergebnis_Kr(5,n));
        Ergebnis_Kr(163,n)=Kl*0.1;
        Ergebnis_Kr(164,n)=Kl*0.3;
        Ergebnis_Kr(165,n)=Kl*0.5;
        Ergebnis_Kr(166,n)=Kl*0.7;
        Ergebnis_Kr(167,n)=fzg_x_t00(Ergebnis_Kr(10,n))-fzg_x_t00(Ergebnis_Kr(5,n));
